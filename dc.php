...
// Récupérer les livres de la série DC Comics
$sql = "SELECT id, titre, serie, numero, disponible, image FROM livres WHERE serie = 'DC Comics' ORDER BY numero";
...
<head>
    <meta charset="UTF-8">
    <title>DC Comics - Librairie en Ligne</title>
...
<body>
    ...
    <p>
        ...
        <?php elseif ($role === 'lecteur') : ?>
            Bienvenue, Lecteur ! Découvrez les livres DC Comics ci-dessous.
        <?php endif; ?>
    </p>
    ...
    <div class="book-grid">
        <?php if ($result->num_rows > 0) : ?>
            ...
            <?php endwhile; ?>
        <?php else : ?>
            <p>Aucun livre DC Comics trouvé.</p>
        <?php endif; ?>
    </div>
