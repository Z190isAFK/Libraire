...
// Récupérer les livres de la série Invincible
$sql = "SELECT id, titre, serie, numero, disponible, image FROM livres WHERE serie = 'Invincible' ORDER BY numero";
...
<head>
    <meta charset="UTF-8">
    <title>Invincible - Librairie en Ligne</title>
...
<body>
    ...
    <p>
        ...
        <?php elseif ($role === 'lecteur') : ?>
            Bienvenue, Lecteur ! Découvrez les livres Invincible ci-dessous.
        <?php elseif ($role === 'administrateur') : ?>
            Bienvenue, Administrateur ! Découvrez les livres Invincible ci-dessous.
        <?php endif; ?>
    </p>
    ...
    <div class="book-grid">
        <?php if ($result->num_rows > 0) : ?>
            ...
            <?php endwhile; ?>
        <?php else : ?>
            <p>Aucun livre Invincible trouvé.</p>
        <?php endif; ?>
    </div>
