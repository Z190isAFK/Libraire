...
// Récupérer les livres de la série Marvel
$sql = "SELECT id, titre, serie, numero, disponible, image FROM livres WHERE serie = 'Marvel' ORDER BY numero";
...
<head>
    <meta charset="UTF-8">
    <title>Marvel - Librairie en Ligne</title>
...
<body>
    ...
    <p>
        ...
        <?php elseif ($role === 'lecteur') : ?>
            Bienvenue, Lecteur ! Découvrez les livres Marvel ci-dessous.
        <?php endif; ?>
    </p>
